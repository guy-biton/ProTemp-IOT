...
if __name__ == '__main__':
    if db_init:
        ...
        # insertion init IOT dataset
        numb =create_IOT_dev('Vaccine_Unit', 'on', 'celcius', timestamp(), 300, 'Warehouse', 'Zone A', 'Freezer 1', 'Floor', 'freezer', 'enabled', 'state', 'mode', 'fan', '-20', comm_topic+'Vaccine_Unit/pub', comm_topic+'Vaccine_Unit/sub', 'done')
        numb =create_IOT_dev('Food_Unit', 'on', 'celcius', timestamp(), 300, 'Warehouse', 'Zone B', 'Fridge 1', 'Floor', 'fridge', 'enabled', 'state', 'mode', 'fan', '4', comm_topic+'Food_Unit/pub', comm_topic+'Food_Unit/sub', 'done')
        numb =create_IOT_dev('Warehouse_Ambient', 'on', 'celcius', timestamp(), 300, 'Warehouse', 'Main', 'Room', 'Wall', 'sensor', 'enabled', 'state', 'mode', 'fan', '22', comm_topic+'Warehouse_Ambient/pub', comm_topic+'Warehouse_Ambient/sub', 'done')
        numb =create_IOT_dev('Backup_Cooler', 'off', 'celcius', timestamp(), 300, 'Warehouse', 'Backup', 'AC', 'Wall', 'actuator', 'enabled', 'cooling', 'mode', 'fan', '20', comm_topic+'Backup_Cooler/pub', comm_topic+'Backup_Cooler/sub', 'changed')
        numb =create_IOT_dev('Main_Power', 'on', 'kWh', timestamp(), 3600, 'PowerStation', 'Main', 'Meter', 'Wall', 'meter', 'enabled', 'state', 'mode', 'fan', 'NA', comm_topic+'Main_Power/pub', comm_topic+'Main_Power/sub', 'done')
