# Class of Industrial IOT devices (emulators) like: Vaccine Unit, Food Unit, Power Meter etc.
import sys
import random
...
if __name__ == '__main__':
    ...
    try:
        ...
        argv=sys.argv
        if len(sys.argv)==1:
            argv.append('Backup_Cooler')
            argv.append('Celsius')
            argv.append('Warehouse_Backup')
            argv.append('7')
